<?php
// DOWNLINE CONTRIBUTIONS PAGE - downline_contributions.php
...
<body class="bg-gray-100 text-gray-800">
  ...
  <header class="bg-indigo-700 text-white p-4 flex justify-between items-center shadow fixed w-full z-10">
    <div class="flex items-center">
      ...
      <h1 class="text-xl font-semibold">XYZ Church Contribution</h1>
    </div>
    <div class="flex items-center space-x-4">
      <span class="hidden md:inline">Welcome, <?php echo htmlspecialchars($user['name']); ?></span>
      <a href="logout.php" class="bg-white text-indigo-700 px-4 py-2 rounded hover:bg-gray-100 transition">Logout</a>
    </div>
  </header>

  <div class="flex pt-16">
    <!-- Sidebar -->
    <aside id="sidebar" class="bg-indigo-800 text-white w-64 min-h-screen fixed z-10 transition-transform duration-300 ease-in-out md:translate-x-0 transform -translate-x-full">
      <div class="p-4">
      ...
      <div class="mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div class="flex-1">
              <div class="flex">
                <input type="text" id="referral-link" value="<?php echo htmlspecialchars($referral_link); ?>" class="w-full p-2 border border-gray-300 rounded-l-md bg-gray-50 text-gray-800" readonly>
                <button id="copy-link" class="bg-indigo-600 text-white px-4 py-2 rounded-r-md hover:bg-indigo-700 focus:outline-none">
                  <i class="fas fa-copy"></i>
                </button>
              </div>
              <p class="text-sm text-gray-500 mt-2">Share this link with friends to earn rewards on their contributions</p>
            </div>
            <div class="flex flex-wrap gap-2">
              <a href="https://wa.me/?text=<?php echo urlencode('Join me on XYZ Platform! Use my referral link: ' . $referral_link); ?>" target="_blank" class="bg-green-500 text-white p-2 rounded-full hover:bg-green-600 transition" title="Share on WhatsApp">
                <i class="fab fa-whatsapp"></i>
              </a>
              <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($referral_link); ?>" target="_blank" class="bg-blue-600 text-white p-2 rounded-full hover:bg-blue-700 transition" title="Share on Facebook">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Join me on XYZ Platform! Use my referral link: ' . $referral_link); ?>" target="_blank" class="bg-blue-400 text-white p-2 rounded-full hover:bg-blue-500 transition" title="Share on Twitter">
                <i class="fab fa-twitter"></i>
              </a>
              <a href="mailto:?subject=Join%20me%20on%20XYZ%20Platform&body=<?php echo urlencode('Hello! Join me on XYZ Platform using my referral link: ' . $referral_link); ?>" class="bg-red-500 text-white p-2 rounded-full hover:bg-red-600 transition" title="Share via Email">
                <i class="fas fa-envelope"></i>
              </a>
              <a href="sms:?body=<?php echo urlencode('Join me on XYZ Platform! Use my referral link: ' . $referral_link); ?>" class="bg-yellow-500 text-white p-2 rounded-full hover:bg-yellow-600 transition" title="Share via SMS">
                <i class="fas fa-sms"></i>
              </a>
            </div>
          </div>
          <div class="mt-4">
            <p class="font-medium">My Referral Code: <span class="bg-gray-100 px-2 py-1 rounded"><?php echo htmlspecialchars($user['referral_code']); ?></span></p>
          </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
          <form action="" method="get" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select id="period" name="period" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                <option value="7days" <?php echo $filter_period == '7days' ? 'selected' : ''; ?>>Last 7 Days</option>
                <option value="30days" <?php echo $filter_period == '30days' ? 'selected' : ''; ?>>Last 30 Days</option>
                <option value="90days" <?php echo $filter_period == '90days' ? 'selected' : ''; ?>>Last 90 Days</option>
            ...
            <div>
              ...
              <select id="user_id" name="user_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <?php foreach ($downline_users as $downline_user): ?>
                  ...
                  <option value="<?php echo $downline_user['id']; ?>" <?php echo $filter_user == $downline_user['id'] ? 'selected' : ''; ?>>
            ...
            <div class="flex items-end">
              ...
              <a href="downline_contributions.php" class="ml-2 text-gray-600 hover:text-gray-800 px-4 py-2">
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-start">
              <div>
                ...
                <p class="text-3xl font-bold">$<?php echo number_format($personal_contribution ?? 0, 2); ?></p>
              </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-start">
              <div>
                ...
                <p class="text-3xl font-bold">$<?php echo number_format($summary['total_amount'] ?? 0, 2); ?></p>
              </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-start">
              <div>
                ...
                <p class="text-3xl font-bold"><?php echo number_format($summary['unique_contributors'] ?? 0); ?></p>
              </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <a href="referral_tree.php" class="text-indigo-600 hover:text-indigo-800">View Full Tree <i class="fas fa-arrow-right ml-1"></i></a>
          </div>
              ...
              <li>
                <details open>
                  <summary class="flex items-center pl-8 py-2">
                    <span class="font-medium ml-2"><?php echo htmlspecialchars($user['name']); ?> (You)</span>
                    <span class="ml-2 bg-indigo-100 text-indigo-800 text-xs px-2 py-1 rounded">$<?php echo number_format($personal_contribution ?? 0, 2); ?></span>
                  </summary>
                  ...
                  <ul id="tree-first-level">
                    ...
                    ?>
                      <li>
                        <details>
                          <summary class="flex items-center pl-8 py-2">
                            <span class="font-medium ml-2"><?php echo htmlspecialchars($referral['name']); ?></span>
                            <span class="ml-2 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">$<?php echo number_format($referral['contribution_total'], 2); ?></span>
                            <span class="ml-2 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">$<?php echo number_format($referral['contribution_total'], 2); ?></span>
                            <?php if ($referral['has_children'] > 0): ?>
                              <span class="ml-2 text-xs text-gray-500">(<?php echo $referral['has_children']; ?> referrals)</span>
                            <?php endif; ?>
                          </summary>
                          
                          <?php if ($referral['has_children'] > 0): ?>
                          <ul>
                            <li class="py-2 pl-8 text-blue-600 hover:underline cursor-pointer" onclick="window.location='referral_tree.php?focus=<?php echo $referral['id']; ?>'">
                              <i class="fas fa-eye mr-1"></i> View <?php echo htmlspecialchars($referral['name']); ?>'s downline
                            </li>
                          </ul>
                          <?php endif; ?>
                        </details>
              ...
              <table class="min-w-full bg-white">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Total Amount</th>
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Contributions</th>
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Referred By</th>
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Last Contribution</th>
                  </tr>
                </thead>
                  ...
                  <?php foreach ($top_contributors as $contributor): ?>
                    <tr class="hover:bg-gray-50">
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="h-8 w-8 flex-shrink-0 bg-indigo-100 text-indigo-700 rounded-full flex items-center justify-center">
                            <i class="fas fa-user"></i>
                          </div>
                          <div class="ml-3">
                            <p class="text-gray-900 font-medium"><?php echo htmlspecialchars($contributor['name']); ?></p>
                          </div>
                        </div>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="text-gray-900">$<?php echo number_format($contributor['total_amount'], 2); ?></div>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="text-gray-700"><?php echo $contributor['contributions_count']; ?> contributions</div>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="text-gray-700"><?php echo htmlspecialchars($contributor['referred_by']); ?></div>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="text-gray-700"><?php echo date('M j, Y', strtotime($contributor['last_contribution'])); ?></div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              ...
              <table class="min-w-full bg-white">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">User</th>
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Amount</th>
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Type</th>
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Referred By</th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                  <?php foreach ($contributions as $contribution): ?>
                    <tr class="hover:bg-gray-50">
                      ...
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="text-gray-900 font-medium"><?php echo htmlspecialchars($contribution['user_name']); ?></div>
                          <?php if ($contribution['their_referrals'] > 0): ?>
                            <div class="ml-2 tooltip">
                              ...
                              <span class="tooltiptext">This user has referred <?php echo $contribution['their_referrals']; ?> people</span>
                            </div>
                          <?php endif; ?>
                        </div>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="text-gray-900 font-medium">$<?php echo number_format($contribution['amount'], 2); ?></div>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <?php 
                        $type_badge_class = '';
                        ...
                        ?>
                        <span class="px-2 py-1 inline-flex text-xs leading-5 font-medium rounded-full <?php echo $type_badge_class; ?>">
                          <?php echo ucfirst($contribution['type']); ?>
                        </span>
                      </td>
                      <td class="py-3 px-4 whitespace-nowrap">
                        <div class="text-gray-700"><?php echo htmlspecialchars($contribution['referred_by']); ?></div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
            ...
            <?php if ($total_pages > 1): ?>
              <div class="mt-4 flex justify-between items-center">
                ...
                <div class="flex space-x-1">
                  ...
                  <?php if ($page > 1): ?>
                    <a href="<?php echo buildPaginationUrl($page - 1); ?>" class="px-3 py-2 border rounded-md text-sm text-gray-700 hover:bg-gray-50">
                      Previous
                    </a>
                  <?php endif; ?>
  ...
  <script>
            ...
            tooltip: {
              callbacks: {
                label: function(context) {
                  return '$' + parseFloat(context.raw).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                }
              }
            },
            legend: {
    ...
    const createContributionLevelChart = () => {
      ...
      // Prepare data
      const levels = <?php echo json_encode(array_map(function($item) { return 'Level ' . $item['level']; }, $level_data)); ?>;
              ...
              callbacks: {
                label: function(context) {
                  if (context.dataset.label === 'Total Amount') {
                    return 'Total: $' + parseFloat(context.raw).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                  } else {
