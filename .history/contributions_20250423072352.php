...
<head>
    ...
    <style>
        ...
        .main-content.sidebar-open {
            padding-left: 16rem; /* 64px/16 = 16rem */
        }
...
<body class="bg-gray-100 text-gray-800">
    <!-- Header -->
    <header class="bg-indigo-700 text-white p-4 flex justify-between items-center shadow fixed w-full z-20">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="bg-indigo-800 text-white w-64 min-h-screen fixed z-10 sidebar-transition md:translate-x-0 transform -translate-x-full">
        <div class="p-4 pt-20"> <!-- Added padding-top to prevent overlap with header -->
            <nav>
                <ul class="space-y-2">
                    <li>
                        <a href="user_dashboard.php" class="block p-2 hover:bg-indigo-700 rounded">
                            <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="referral_tree.php" class="block p-2 hover:bg-indigo-700 rounded">
                            <i class="fas fa-sitemap mr-2"></i> Referral Tree
                        </a>
                    </li>
                    <li>
                        <a href="contributions.php" class="block p-2 bg-indigo-700 rounded">
                            <i class="fas fa-hand-holding-usd mr-2"></i> Contributions
                        </a>
                    </li>
                    <li>
                        <a href="logout.php" class="block p-2 hover:bg-indigo-700 rounded">
    ...
    <!-- Main Content -->
    <main id="main-content" class="pt-16 main-content">
        <div class="p-6">
            <div class="mb-8">
