  ...
  <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
    ...
    <form method="POST">
      ...
      <div class="mb-6">
        ...
        <input type="text" name="referral" id="referral" placeholder="Referral Code" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" value="<?php echo htmlspecialchars($referralCode ?? ''); ?>">
