...
<body class="bg-gray-100">
  ...
  <!-- Page Wrapper -->
  <div class="flex min-h-screen pt-16"> <!-- Added top padding to account for fixed header -->
    <!-- Sidebar -->
    ...
    <main class="flex-1 p-3 md:p-6">
      ...
      <section class="mb-6 bg-white p-4 md:p-6 rounded-lg shadow">
        ...
        <div class="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
          <input id="referralLink" type="text" class="w-full p-2 border rounded" value="<?php echo $referral_link; ?>" readonly>
          <button onclick="copyReferralLink()" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
        ...
        <div class="mt-4 share-buttons-wrapper">
          ...
          <a href="https://wa.me/?text=<?php echo urlencode($referral_link); ?>" target="_blank" class="share-btn"><i class="fab fa-whatsapp"></i> WhatsApp</a>
          <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($referral_link); ?>" target="_blank" class="share-btn"><i class="fab fa-facebook-f"></i> Facebook</a>
          <a href="mailto:?subject=Join me on our platform&body=<?php echo urlencode($referral_link); ?>" class="share-btn"><i class="fas fa-envelope"></i> Email</a>
        </div>
      </section>
      ...
      <section class="mb-6 bg-white p-4 md:p-6 rounded-lg shadow">
        ...
        <p class="text-gray-600">This includes your contributions and those of everyone in your referral network.</p>
      </section>
      ...
      <!-- Direct Referrals List and Contributions Analysis -->
      <section class="bg-white p-4 md:p-6 rounded-lg shadow">
        <h2 class="text-xl font-semibold mb-4">My Direct Invites</h2>
          ...
          <div class="responsive-table">
            <table class="min-w-full table-auto">
              ...
              <tbody>
                ...
                <tr class="border-b">
                  <td class="px-4 py-2">
                    <a href="referral_tree.php?focus=<?php echo $ref['id']; ?>" class="text-indigo-600 hover:underline">
                      <?php echo htmlspecialchars($ref['name']); ?>
                    </a>
                  </td>
                  <td class="px-4 py-2 text-center"><?php echo $ref['referral_count']; ?></td>
                  <td class="px-4 py-2 text-center"><?php echo number_format($ref['contribution_amount'], 2); ?></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
