                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-3xl font-bold">$<?php echo number_format($personal_contribution ?? 0, 2); ?>
                            </p>
                        </div>
            ...
            ?>
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo number_format($project['contributions_count']); ?>
                                </td>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($contributor['referred_by'] ?? 'Direct'); ?>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo number_format($contributor['contributions_count']); ?>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">
                                    $<?php echo number_format($contributor['total_amount'], 2); ?>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($contribution['referred_by'] ?? 'Direct'); ?>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">
                                    $<?php echo number_format($contribution['amount'], 2); ?>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($contribution['project_name']); ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($referral_link); ?>"
                            target="_blank" class="bg-blue-600 text-white p-2 rounded-full hover:bg-blue-700 transition"
                        ...
                        <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Join me on XYZ Platform! Use my referral link: ' . $referral_link); ?>"
                            target="_blank" class="bg-blue-400 text-white p-2 rounded-full hover:bg-blue-500 transition"
