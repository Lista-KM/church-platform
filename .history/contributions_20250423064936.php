    ...
    <div class="flex pt-16">
        ...
        <main class="flex-1 md:ml-64 p-6">
            <div class="mb-8">
                ...
                <!-- Corrected Summary Cards Section -->
                <?php
// Fix the personal contribution query to correctly apply the same filters
$personal_sql = "
    SELECT COALESCE(SUM(amount), 0) as personal_total 
    FROM contributions 
...
// Add date filter (properly converted from the main query's date filter)
if (!empty($date_filter)) {
    $date_filter_personal = str_replace('AND c.', 'AND ', $date_filter);
...
// Calculate the combined total after all filters are applied
$combined_total = ($personal_contribution ?? 0) + ($summary['total_amount'] ?? 0);
?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="mt-2 text-sm text-gray-600">
                            ...
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded ml-2">Filtered</span>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md bg-gradient-to-r from-indigo-50 to-blue-50">
                        ...
                        <div class="mt-2 text-sm text-gray-600">
                            <?php if ($filter_user === 'all' && $filter_project === 'all' && $filter_period === 'all'): ?>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="mt-2 text-sm text-gray-600">
                            <?php if ($filter_user !== 'all'): ?>
                            <span class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded">Selected
                                branch</span>
                            <?php else: ?>
