...
// Base URL (add subdirectory if needed)
$base_url = $protocol . $_SERVER['HTTP_HOST'];
$base_url .= '/church-platform'; // Modify if your subdirectory name is different

// Build the referral link
$referral_link = rtrim($base_url, '/') . '/landing.php?ref=' . urlencode($user['referral_code']);
