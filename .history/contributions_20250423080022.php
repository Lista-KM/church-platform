                ...
                <div class="bg-white p-4 md:p-6 rounded-lg shadow-md mb-6">
                    <form action="" method="get" class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="flex-grow mb-3 md:mb-0 md:mr-4">
                            <label for="project_id" class="block text-sm font-medium text-gray-600 mb-1">
                                Filter by Project:
                            </label>
                            <select name="project_id" id="project_id"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                <!-- mark “All” when $filter_project==='all' -->
                                <option value="all" <?= $filter_project === 'all' ? 'selected' : '' ?>>
                                    All Projects
                                </option>
                        ...
                        <!-- your Apply & Clear buttons -->
                        <div class="flex-shrink-0 self-end">
                            <button type="submit"
                                class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition">
                                <i class="fas fa-filter mr-2"></i> Apply Filter
                            </button>
                            <?php if ($filter_project !== 'all'): ?>
                            <a href="contributions.php?period=<?= $filter_period ?>&user_id=<?= $filter_user ?>"
