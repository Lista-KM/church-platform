<?php
// REFERRAL ANALYTICS - referral_analytics.php
...
// Get referral chains (generations)
...
// Get referral depth distribution
$stmt = $pdo->query("WITH RECURSIVE ReferralChain AS (
                        SELECT 
                            id, 
                            name, 
...
// Get contribution comparison: referred vs non-referred
$stmt = $pdo->query("SELECT 
                    'Referred' as type,
...
<body class="bg-gray-100 text-gray-800">
  ...
  <div class="flex pt-16">
    ...
    <aside id="sidebar" class="bg-indigo-800 text-white w-64 min-h-screen fixed z-10 transition-transform duration-300 ease-in-out md:translate-x-0 transform -translate-x-full">
      <div class="p-4">
        <div class="border-b border-indigo-700 pb-4 mb-4">
        ...
        <nav>
          <ul class="space-y-2">
            ...
            <li>
              <a href="contribution_reports.php" class="block py-2 px-4 hover:bg-indigo-700 rounded transition">
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-start">
              <div>
                ...
                <p class="text-3xl font-bold"><?php echo number_format($referral_stats['total_users']); ?></p>
              </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-start">
              <div>
                ...
                <p class="text-3xl font-bold"><?php echo number_format($referral_stats['referred_users']); ?></p>
              </div>
            ...
            <div class="mt-2 text-sm">
              <span class="text-green-600 font-medium"><?php echo number_format($referral_percentage, 1); ?>%</span> of all users
            </div>
          </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-start">
              <div>
                ...
                <p class="text-3xl font-bold"><?php echo number_format($referral_stats['referrers']); ?></p>
              </div>
            ...
            <table class="min-w-full bg-white">
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="py-3 px-4 text-right"><?php echo number_format($referrer['referral_count']); ?></td>
                  <td class="py-3 px-4 text-right">$<?php echo number_format($referrer['indirect_contributions'] ?? 0, 2); ?></td>
                  <td class="py-3 px-4 text-center">
                    <a href="user_detail.php?id=<?php echo $referrer['id']; ?>" class="text-blue-600 hover:text-blue-800 mr-3">
                      <i class="fas fa-eye"></i>
                    </a>
                    <a href="referral_tree.php?id=<?php echo $referrer['id']; ?>" class="text-green-600 hover:text-green-800">
            ...
            <table class="min-w-full bg-white">
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="py-3 px-4"><?php echo htmlspecialchars($referral['referrer_name']); ?></td>
                  <td class="py-3 px-4"><?php echo date('M j, Y', strtotime($referral['created_at'])); ?></td>
                  <td class="py-3 px-4 text-right">$<?php echo number_format($referral['contributions'] ?? 0, 2); ?></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
