...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $generatedCode = substr(md5($name . $email . $lastInsertId), 0, 8);
  ...
  <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
    ...
    <form method="POST">
      <div class="mb-4">
        ...
        <input type="text" name="name" id="name" placeholder="Your full name" required class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
      </div>
      ...
      <div class="mb-4">
        ...
        <input type="password" name="password" id="password" placeholder="Create a password" required class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
      </div>

      <div class="mb-6">
        <label for="referral" class="block text-sm font-medium text-gray-600">Referral ID (Optional)</label>
        <input type="text" name="referral" id="referral" placeholder="Referral ID (optional)" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
      </div>
